...
<div class="container">
	<div class="white-block col-xs-12 bottom-mg-2 top-mg-2">
		<form action="/lesson/del/<?php echo $lesson_id; ?>" method="POST">
			<p class="col-xs-10 col-xs-offset-1 size-big black center bottom-mg-2 top-mg-4">Do you want to delete lesson "<?php echo $lesson_data['name']; ?>"?</p>
