...
<div class="container">
	<form action="/trainer/edit" enctype="multipart/form-data" method="post">
		<div class="white-block col-xs-12 top-mg-2">
			...
			<div class="col-xs-12 col-sm-6 col-sm-offset-0 top-mg-2">
				...
				<p class="size-normal up-case bottom-mg-half top-mg-2">How you wont to resive payments</p>
				<input type="text" name="payment" class="full-width" value="<?php echo $user_data['payment']; ?>" required>
				<?php if (isset($errors['payment'])): ?>
					<p class="size-small red up-case top-mg-half">Field can't be empty</p>
				<?php endif ?>

				<p class="size-normal up-case bottom-mg-half top-mg-2">Price for mounth of private courses</p>
				<input  type="number" step="0.01" name="price" class="full-width" value="<?php echo $user_data['price']; ?>" required>
